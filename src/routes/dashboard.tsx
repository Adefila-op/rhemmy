...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen w-full bg-neutral-100 flex items-center justify-center p-0 sm:p-6 font-sans">
      {/* Mobile phone frame */}
      <div className="relative w-full sm:w-[420px] h-screen sm:h-[860px] sm:rounded-[3rem] overflow-hidden bg-orange-500 shadow-2xl sm:border-[10px] sm:border-gray-900">
        {/* Status bar */}
